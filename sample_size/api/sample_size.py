...
def get_sample_size():
    ...
    baseline_conversion_rate = flask.request.args.get('baseline_conversion_rate', default=.3, type=float)
    expected_relative_lift = flask.request.args.get('expected_relative_lift', default=.2, type=float)
    loss_tolerance = flask.request.args.get('loss_tolerance', default=.02, type=float)
    prior_alpha = flask.request.args.get('prior_alpha', default=1, type=int)
    prior_beta = flask.request.args.get('prior_beta', default=1, type=int)

    results = _sample_size_fixed_loss_tolerance(baseline_conversion_rate=baseline_conversion_rate,
